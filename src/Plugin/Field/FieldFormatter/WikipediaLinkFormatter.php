...
namespace Drupal\wikipedia_link_formatter\Plugin\Field\FieldFormatter;
 ...
 *
 * @FieldFormatter(
 *   id = "wikipedia_link_formatter",
 *   label = @Translation("Wikipedia Link Formatter"),
 *   field_types = {
 *     "link"
 *   }
 * )
 */
class WikipediaLinkFormatter extends LinkFormatter {
    ...
    public function viewElements(FieldItemListInterface $items, $langcode) {
        ...
        foreach ($items as $delta => $item) {
            ...
            $element[$delta] = [
                '#theme' => 'wikipedia_link_formatter_link',
                '#title' => $link_title,
                '#url_title' => $url_title,
                '#url' => $url,
            ];
